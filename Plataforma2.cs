...
public class Plataforma2 : MonoBehaviour {
	...
	void Start () {
		...
		plataforma = GameObject.FindGameObjectWithTag ("Plataforma2");
	}
	...
	void Update () {
		if(i<0.5f)
			...
			Vector3 temp = new Vector3(179f,plataforma.transform.position.y,
			...
			float speed = 2*Time.deltaTime;
			Vector3 temp2 = new Vector3(176f,plataforma.transform.position.y,
			                            plataforma.transform.position.z);
